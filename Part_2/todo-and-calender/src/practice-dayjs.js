...
// dayjs에서 import 및 extend를 해야만 사용 가능한 함수들
...
export const runPracticeDayjs = () => {
  ...
  console.log("5. get month", dayjs(now).get("month") + 1); // 0~11(1월~12월)
  ...
  console.log("11. startOf", dayjs(now).startOf("month").format("YYYY.MM.DD")); // 해당 달의 첫번째 날짜
  console.log("12. endOf", dayjs(now).endOf("month").format("YYYY.MM.DD")); // 해당 달의 마지막  날짜
